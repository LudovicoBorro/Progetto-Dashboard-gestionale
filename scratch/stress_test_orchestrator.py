...
if __name__ == "__main__":
    ...
    tests = [
        ...
        ("B1", "Intervals Minimal (B&B)", Instance.get_raw_instance_with_intervals_minimal, {"instant_sol": False, "has_intervals": True, "rcpsp_max": True, "max_nodes": 50000, "max_time": 3600}),
        
        # 4. Intervals Large (Fast B&B)
        ("B2", "Intervals Large (Fast B&B)", Instance.get_raw_instance_with_intervals, {"instant_sol": True, "has_intervals": True, "rcpsp_max": True, "max_nodes": 10000000, "max_time": 21600}),
